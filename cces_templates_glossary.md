...
- **rule_type**: Rule type, one of the following:
  - [https://www.w3.org/TR/odrl-vocab/#term-Permission](https://www.w3.org/TR/odrl-vocab/#term-Permission)
  - [https://www.w3.org/TR/odrl-vocab/#term-Prohibition](https://www.w3.org/TR/odrl-vocab/#term-Prohibition)
  - [https://www.w3.org/TR/odrl-vocab/#term-Duty](https://www.w3.org/TR/odrl-vocab/#term-Duty) (through the `obligation` property)
...
- **rule_assignee_refinement**: Boolean to indicate that the rule's assignee assignee has a refinement (defaults to `false`)
